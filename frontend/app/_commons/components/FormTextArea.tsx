...
const FormTextArea = (props: Props) => {
	...
	const textFieldClass = `${textFieldStyle} ${Object.keys(errors)?.length > 0 ? "border-red-400 ring-red-400" : ""} font-heading text-black dark:text-black h-32`
	...
	return (
		<div className="w-full flex flex-col">
			{label && <p className="my-1 font-heading text-gray-700 dark:text-gray-400">{label}</p>}
