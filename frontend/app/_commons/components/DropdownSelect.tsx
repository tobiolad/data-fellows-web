...
import { textFieldStyle } from "@app/_commons/components/FormInput"
...
const DropdownSelect: React.FC<DropdownSelectProps> = ({
	...
	const renderSelector = () => {
		...
		return (
			<div
				className={twMerge(
					`${textFieldStyle} my-0  flex cursor-pointer flex-row items-center justify-between text-gray-700`,
					className,
				)}
				onClick={handleClick}>
